...
export interface DecodedShareableResult {
  data: DecodedNprofileResult | DecodedNaddrResult | DecodedNeventResult | DecodedNrelay; 
...
export type DecodedNrelay = string;
  ...
  static decodeShareable(data: string): DecodedShareableResult {
    ...
    switch (prefix) {
      ...
      case Nip19ShareableDataPrefix.Nrelay: {
        ...
        return {
          data: utf8Decoder.decode(tlv[0][0]) as DecodedNrelay,
